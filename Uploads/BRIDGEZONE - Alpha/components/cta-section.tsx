      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          ...
          <p className="text-muted-foreground text-sm md:text-base font-medium leading-[18.20px] md:leading-relaxed break-words max-w-2xl">
            Deja de buscar sin rumbo. Publica lo que necesitas y deja que los vendedores te encuentren con las mejores
            ofertas. El marketplace que trabaja para ti.
          </p>
        </div>
        <div className="flex flex-col sm:flex-row gap-4">
          <Link href="#publicar-busqueda">
            <Button
              className="px-[30px] py-2 bg-primary text-primary-foreground text-base font-medium leading-6 rounded-[99px] shadow-[0px_0px_0px_4px_rgba(255,215,0,0.13)] hover:bg-primary-dark transition-all duration-200"
              size="lg"
            >
              Publicar Búsqueda
            </Button>
          ...
          <Link href="#ofrecer-servicio">
            <Button
              className="px-[30px] py-2 bg-secondary text-secondary-foreground text-base font-medium leading-6 rounded-[99px] shadow-[0px_0px_0px_4px_rgba(107,114,128,0.13)] hover:bg-secondary/90 transition-all duration-200"
              size="lg"
            >
              Ofrecer Servicio
            </Button>
